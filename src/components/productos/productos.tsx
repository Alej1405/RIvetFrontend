      ...
      {/* Contenedor del detalle del producto */}
        <div className="md:gap-4 md:my-5">
            ...
            <div className="md:mx-6">
                <h3 className="font-bold text-foreground text-right">{nombre}</h3>
                <p className="font-mundial font-extralight text-muted-foreground">
                    {insing} {espacio}
            ...
            <p className="font-light text-muted-foreground text-[16px] wrap-break-words w-full">
                {detalle ?? "Sin Detalle"}
            </p>
            </div>
            <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-linear-to-r from-primary to-accent hidden md:block rounded-full py-4 mt-10 text-primary-foreground text-sm text-center font-semibold tracking-wide w-[90%] cursor-pointer"
        ...
        <motion.div
            ...
            className="bg-card/50 backdrop-blur-sm p-3 md:w-screen md:mx-5 w-[90%] rounded-lg border border-border/50"
        >
            <motion.div
            ...
            <p className="font-light text-muted-foreground text-[16px] wrap-break-word w-full">
                {detalle ?? "Sin Detalle"}
            </p>
            </div>
            <motion.button
